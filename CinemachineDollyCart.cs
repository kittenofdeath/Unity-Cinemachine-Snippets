...
namespace Cinemachine
{
    ...
    public class CinemachineDollyCart : MonoBehaviour
    {
        ...
        public enum UpdateMethod
        {
            ...
            FixedUpdate,
            IgnoreTimeScaleUpdate,
            IgnoreTimeScaleFixedUpdate
        ...
        void FixedUpdate()
        {
            ...
            else if (m_UpdateMethod == UpdateMethod.IgnoreTimeScaleFixedUpdate)
            {
        ...
        void Update()
        {
            ...
            else if (m_UpdateMethod == UpdateMethod.IgnoreTimeScaleUpdate)
            {
                SetCartPosition(m_Position += m_Speed * Time.unscaledDeltaTime);
                //Debug.Log("doing it"+ Time.unscaledDeltaTime);
            }
